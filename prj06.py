...
def update_theta(theta, nabla_J, epsilon):
    # Done: modify code below as needed
    #updated_theta = theta
    return [theta_i - (epsilon*nabla_i) for theta_i, nabla_i in zip(theta, nabla_J)]   #same as in previous project
...
# hyperparameters
bound = 0.1 # initial weight range
